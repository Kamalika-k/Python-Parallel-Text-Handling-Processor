...
👉 A complete end-to-end automated pipeline via run.py 👉 A full interactive GUI dashboard via streamlit_app.py
...
sha256(text)
If hash already exists in DB → skipped. This saves compute and prevents duplicates.
